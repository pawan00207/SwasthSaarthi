          ...
          <div className="steps2-container2 thq-grid-2">
            <div className="steps2-section-header">
              ...
              <p className="thq-body-large">
                Experience innovation and quality like never before. Our
                products are designed to deliver exceptional performance,
                reliability, and value. Whether you’re looking for everyday
                solutions or advanced features, we have exactly what you need to
                  ...
                  {props.step3Description ?? (
                    <Fragment>
                      <span className="steps2-text26">
                        Book a virtual appointment with a healthcare provider
                  ...
                  {props.step4Description ?? (
                    <Fragment>
                      <span className="steps2-text31">
                        Get your prescribed medications delivered to your
                        doorstep for convenience and timely treatment.
                      </span>
                    </Fragment>
                  )}
                </span>
