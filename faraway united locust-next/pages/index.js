          ...
          review2={
            <Fragment>
              <span className="home-text196">
                As a teacher in a remote village, accessing healthcare was
                always a challenge. Swasth Saarthi has made it convenient for me
                to seek medical advice and get prescriptions delivered to my
                doorstep. The mental wellness chatbot has also helped me manage
                stress better.
              </span>
            </Fragment>
          }
          ...
          content1={
            <Fragment>
              <span className="home-text200">
                ...
                now consult with doctors without traveling long distances,
          ...
          review1={
            <Fragment>
              <span className="home-text202">
                Swasth Saarthi has transformed healthcare access in my village.
                I can now connect with doctors without leaving my farm, saving
                both time and money. The platform’s accurate AI symptom checker
                and timely medicine delivery have been a true blessing for my
                family.
              </span>
            </Fragment>
          }
          ...
          review3={
            <Fragment>
              <span className="home-text204">
                ...
                telemedicine consultations have been prompt and effective, and
                the multi-language support is a game-changer for our community.
              </span>
            </Fragment>
          }
          review4={
            <Fragment>
              <span className="home-text205">
                ...
                platform&apos;s integration with government programs ensures
                that even the most vulnerable populations have access to
