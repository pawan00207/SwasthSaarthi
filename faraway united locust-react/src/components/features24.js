          ...
          >
            ...
            <div className="features24-content1">
              <h2 className="thq-heading-2">
                {props.feature1Title ?? (
                  <Fragment>
                    <span className="features24-text4">AI Symptom Checker</span>
                  </Fragment>
                )}
              </h2>
          ...
          >
            ...
            <div className="features24-content3">
              <h2 className="thq-heading-2">
                {props.feature3Title ?? (
                  <Fragment>
                    <span className="features24-text2">Medicine Delivery</span>
                  </Fragment>
                )}
              </h2>
              <span className="thq-body-small">
                {props.feature3Description ?? (
                  <Fragment>
                    <span className="features24-text1">Medicine delivery</span>
                  </Fragment>
                )}
              </span>
            </div>
...
Features24.defaultProps = {
  feature1ImgAlt: 'AI symptom checker',
  ...
  feature3ImgAlt: 'Medicine delivery',
  ...
  feature2ImgAlt: 'Telemedicine consultations',
